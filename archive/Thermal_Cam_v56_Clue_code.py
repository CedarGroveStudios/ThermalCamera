...
# Define buttons
focus_button = DigitalInOut(board.BUTTON_DOWN)
focus_button.direction = Direction.INPUT
focus_button.pull = Pull.DOWN

hold_button = DigitalInOut(board.BUTTON_UP)
hold_button.direction = Direction.INPUT
hold_button.pull = Pull.DOWN

mode_button = DigitalInOut(board.BUTTON_SELECT)
mode_button.direction = Direction.INPUT
mode_button.pull = Pull.DOWN
