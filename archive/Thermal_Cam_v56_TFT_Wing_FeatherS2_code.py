# Thermal_Cam_v56_TFT_Wing_FeatherS2_code.py
# 2021-05-28 v5.6
# 2.4in TFT FeatherWing + FeatherS2 version
...
display_bus = displayio.FourWire(
    board.SPI(), command=board.D6, chip_select=board.D5, reset=board.D21
)
...
while True:
    ...
    t7 = time.monotonic()
    print("---TFT FeatherWing/FeatherS2")
