# Thermal_Cam_v56_2_4_TFT_Wing_nRF52840.py
# 2021-05-27 v5.6
# 2.4in TFT FeatherWing + Feather nRF52840 version
...
display_bus = displayio.FourWire(
    board.SPI(), command=board.D10, chip_select=board.D9, reset=board.D6
)
...
while True:
    ...
    t7 = time.monotonic()
    print("---2.4in TFT FeatherWing/nRF52840")
